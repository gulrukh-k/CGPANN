...
int main(int argc, char* argv[])
{
	...
	char testfile[MAX_NUM_LETTERS] = "iristest1.dat";

	char trainfile[MAX_NUM_LETTERS] = "iristrain1.dat";

	char testout[MAX_NUM_LETTERS] = "iristestout_2.txt";

	char trainout[MAX_NUM_LETTERS] = "iristrainout_2.txt";
