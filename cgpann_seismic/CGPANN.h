...
#define DATA_IS_DOUBLE // CGPANN uses double
...
#define MAX_NUM_COLS				300
#define MAX_NUM_INPUTS				42
#define MAX_NUM_OUTPUTS				1
#define MAX_NUM_DATA				111000
#define MAX_NUM_NODES				MAX_NUM_ROWS*MAX_NUM_COLS
#define MAX_NUM_NODES_PLUS_INPUTS	MAX_NUM_NODES+MAX_NUM_INPUTS
#define MAX_NUM_GENES_PER_NODE		((3 * MAX_NUM_INPUTS) + 1) // genes per node is triple the inputs plus output. 
...
*/
#define MAX_NUM_CHROMOSOMES			10  /* max population size */
...
data_type	    cgpout1[MAX_NUM_DATA][MAX_NUM_OUTPUTS];//Gulrukh
